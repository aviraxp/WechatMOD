...
public class ObfuscationHelper {
    ...
    */
    ...
    public static class MM_Res {
        ...
        private static void init(int idx, LoadPackageParam lpparam) throws Throwable {
            color.action_bar_color = new int[]{2131231144, 2131231131, 2131231144, 2131689496}[idx]; /*setBackgroundDrawable((Drawable)new ColorDrawable(this.getResources().getColor*/
        }
    }
